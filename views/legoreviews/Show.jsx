...
class Show extends React.Component {
  render () {
    ...
    const { review, rating, isItFavorite, nameOfSet, collectionName,link, image, _id } = this.props.review
    return (
    // Code Block
      <Default title={`${nameOfSet} | ${collectionName} Review`} review={this.props.review}>
